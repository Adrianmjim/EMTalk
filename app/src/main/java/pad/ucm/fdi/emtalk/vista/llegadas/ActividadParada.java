...
public class ActividadParada extends AppCompatActivity implements Observer, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final GestorConexion g = (GestorConexion)getApplication();
    ...
    private void setInfo(ListaLlegadas l) {
        info = l.getArrives();
        adapter = new AdaptadorLlegada(this, l.getArrives());
    ...
    public void onClick(View view) {
        int itemPosition = vistaPrueba.getChildLayoutPosition(view);
        Arrive info = this.info.get(itemPosition);
        Intent i = new Intent(this, ActividadTrack.class);
        i.putExtra("idStop", info.getStopId());
        i.putExtra("idBus", info.getBusId());
        i.putExtra("idLine", info.getLineId());
        startActivity(i);
    }
}